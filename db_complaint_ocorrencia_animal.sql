...
CREATE TABLE `ocorrencia_animal` (
  `id_ocanimal` int unsigned NOT NULL AUTO_INCREMENT,
  `especie` varchar(60) NOT NULL,
  `quantidade` int NOT NULL,
  `endereco_ocanimal` varchar(100) NOT NULL,
  `complemento_ocanimal` varchar(100) DEFAULT NULL,
  `cidade` varchar(60) NOT NULL DEFAULT 'Recife',
  `estado` varchar(20) NOT NULL DEFAULT 'Pernambuco',
  `cidade_proxima` varchar(45) DEFAULT NULL,
  `cep_ocanimal` varchar(8) NOT NULL,
  `telefone` varchar(11) NOT NULL,
  `id_origem` int NOT NULL,
  PRIMARY KEY (`id_ocanimal`),
  UNIQUE KEY `id_UNIQUE` (`id_ocanimal`)
